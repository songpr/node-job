...
class Job {
    constructor({
        ...
        if (jobHandle === undefined || typeof (jobHandle) !== 'function') {
            throw new TypeError(
                'jobHandle must be provided and must be a function'
            )
        }
